...
export class InvoicesController {
  ...
  @Get('eligible-client/:projectId')
  @UseGuards(RolesGuard)
  @Roles('SUPER_ADMIN', 'ADMIN', 'ACCOUNT_MANAGER', 'PROJECT_MANAGER')
  getClientEligibleMilestones(@Param('projectId', ParseIntPipe) projectId: number) {
    return this.invoicesService.getClientEligibleMilestones(projectId);
  }

  @Post('auto-generate-client')
  @UseGuards(RolesGuard)
  @Roles('SUPER_ADMIN', 'ADMIN', 'ACCOUNT_MANAGER', 'PROJECT_MANAGER')
  autoGenerateClientDraft(
    @Body('projectId') projectId: number,
    @Req() req: any,
  ) {
    return this.invoicesService.autoGenerateClientDraft(projectId, req.user.id);
  }
